...
class Parca(pygame.sprite.Sprite):
    def __init__(self): # python fonksiyonlarını kullanmak için init() aktifleştirmiştik burda da nesne tab. kullanabilmek için aktifleştiriyoruz.
...
#parçacıkların bir resme ve boyuta ihtiyacı var yani image ve rect boyutları olması gerekiyor.
        self.image=pygame.Surface((100,100)) #oluşturuduğumuz nesneye genişlik ve yükseklik verdik yani boyutlandırdık
