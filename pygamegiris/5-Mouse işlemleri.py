...
while True: #bu döngü sayesinde pencereyi açık tutuyoruz.
    ...
    mouseX,mouseY=pygame.mouse.get_pos() #mouse x y değerlerini birer değişkene atadık,
    # tuple olduğu için birden fazla atama yapabiliriz.
    if mouseX+top.get_size()[0]>800 or mouseY+top.get_size()[1]>600:
        mouseX-=top.get_size()[0]
        mouseY -= top.get_size()[1]
