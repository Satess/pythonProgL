    ...
    for event in pygame.event.get():  # pygame eventlerden yani olaylardan oluşur.
        ...
        if event.type==pygame.KEYDOWN:
            if event.key==pygame.K_RIGHT:
                sprite_Grup.update()  # update fonksiyonu ile hepsini birlikte hareket ettireceğiz.
                #klavyeden sağ tuşa basıldığı anda update et ve spriteler hareket etsin.
...
#evente baplı olarakta hareket ettirebiliriz.
#bir tuşa basılırsa eğer hareket et gibi